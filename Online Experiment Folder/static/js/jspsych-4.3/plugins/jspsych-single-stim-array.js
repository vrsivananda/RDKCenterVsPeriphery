...
(function($) {
	jsPsych["single-stim-array"] = (function() {
		...
		plugin.create = function(params) {
			...
			var trials = new Array(params.numTrials);
			alert('params.numTrials '+params.numTrials);
			alert('trials.length '+trials.length);
			alert('params.stimuli.length '+params.stimuli.length);
			for (var i = 0; i < trials.length; i++) {
				trials[i] = {};
				alert('params.stimuli['+i+'] ' +params.stimuli[i]);
